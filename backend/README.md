...
## Project Structure
    ...
    ├── testapiautoteammem_103259  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_103259`
...
2. Clone this repo and `cd testapiautoteammem_103259`
